  ...
  db.query('DROP TABLE IF EXISTS patienToDoctor;', (err, res) => {
   if (err.error)
    ...
    db.query('CREATE TABLE patientodoctor(patientid integer NOT NULL,doctorid integer NOT NULL,validfrom date NOT NULL,validto date NOT NULL,PRIMARY KEY (patientid, doctorid));', (err, res) => {
