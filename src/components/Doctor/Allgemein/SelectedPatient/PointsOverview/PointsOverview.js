                    ...
                    {this.props.health.first_step_points === 0 ? (<p style={{color: 'black', fontStyle: 'italic'}}>no bad health data.</p>) : (null)}
                     ...
                     { this.props.health.detailed_first_step_points.temperature_low > 0 || this.props.health.detailed_first_step_points.temperature_hight > 0 ? (
                      <span>
                        ...
                        {this.props.health.detailed_first_step_points.temperature_high > 0 ? ( <p style={{fontSize: '15px', fontStyle: 'italic', marginTop: '-15px', paddingLeft: '20px'}} > - {this.props.health.detailed_first_step_points.temperature_high} days of high risk temerature <span style={{fontSize: '12px'}} > (2x{this.props.health.detailed_first_step_points.temperature_high} points)</span>. </p>) : (null)}
                      </span>
                      ) : (null)}
                  ...
                  <div className="row">
                    <div className="col-12">
                      <p style={{fontSize: '15px', color: 'black'}}> - {med.title} {this.get_total_med_missed(med)} times
                          ...
                          {med.history.filter( entry => {return !entry.measured}).length > 0 && this.props.health.first_step_points > 5 ? (<span style={{color: 'red', fontSize: '12px'}} > (3x{this.get_total_med_missed(med)} points)</span>) : (null)} 

                          {med.history.filter( entry => {return !entry.measured}).length > 0 && this.props.health.first_step_points >= 2 && this.props.health.first_step_points <= 5 ? (<span style={{color: '#ffc459', fontSize: '12px'}} > (2x{this.get_total_med_missed(med)} points)</span>) : (null)} 

                          {med.history.filter( entry => {return !entry.measured}).length > 0 && this.props.health.first_step_points < 2 ? (<span style={{color: 'green', fontSize: '12px'}} > 1x({this.get_total_med_missed(med)} points)</span>) : (null)} 
                      </p>
                     ...
                     { this.props.health.detailed_final_step_points.temperature > 0 ? (
                      <span>
                       ...
                       <p style={{fontSize: '15px', fontStyle: 'italic', marginTop: '-15px', paddingLeft: '20px'}} > - No entry on {this.props.health.detailed_final_step_points.temperature} days 
                          {this.props.health.first_step_points <= 1 ? (<span style={{color: 'green',fontSize: '12px'}}> (1x{this.props.health.detailed_final_step_points.temperature} points)</span>) : null}
                          {this.props.health.first_step_points === 2 || this.props.health.first_step_points === 3 ? (<span style={{color: '#ffc459', fontSize: '12px'}}> (2x{this.props.health.detailed_final_step_points.temperature} points)</span>) : null}
                          {this.props.health.first_step_points > 3 ? (<span style={{color: 'red',fontSize: '12px'}}> (3x{this.props.health.detailed_final_step_points.temperature} points)</span>) : null}
                       .</p>
                      </span>
                      ) : (null)}
                     ...
                     { this.props.health.detailed_final_step_points.pulse > 0 ? (
                      <span>
                       ...
                       <p style={{fontSize: '15px', fontStyle: 'italic', marginTop: '-15px', paddingLeft: '20px'}} > - No entry on {this.props.health.detailed_final_step_points.pulse} days 
                          {this.props.health.first_step_points <= 1 ? (<span style={{color: 'green',fontSize: '12px'}}> (1x{this.props.health.detailed_final_step_points.pulse} points)</span>) : null}
                          {this.props.health.first_step_points === 2 || this.props.health.first_step_points === 3 ? (<span style={{color: '#ffc459', fontSize: '12px'}}> (2x{this.props.health.detailed_final_step_points.pulse} points)</span>) : null}
                          {this.props.health.first_step_points > 3 ? (<span style={{color: 'red',fontSize: '12px'}}> (3x{this.props.health.detailed_final_step_points.pulse} points)</span>) : null}
                       .</p>
                      </span>
                      ) : (null)}
                     ...
                     { this.props.health.detailed_final_step_points.blood_pressure > 0 ? (
                      <span>
                       ...
                       <p style={{fontSize: '15px', fontStyle: 'italic', marginTop: '-15px', paddingLeft: '20px'}} > - No entry on {this.props.health.detailed_final_step_points.blood_pressure} days 
                          {this.props.health.first_step_points <= 1 ? (<span style={{color: 'green',fontSize: '12px'}}> (1x{this.props.health.detailed_final_step_points.blood_pressure} points)</span>) : null}
                          {this.props.health.first_step_points === 2 || this.props.health.first_step_points === 3 ? (<span style={{color: '#ffc459', fontSize: '12px'}}> (2x{this.props.health.detailed_final_step_points.blood_pressure} points)</span>) : null}
                          {this.props.health.first_step_points > 3 ? (<span style={{color: 'red',fontSize: '12px'}}> (3x{this.props.health.detailed_final_step_points.blood_pressure} points)</span>) : null}
                       .</p>
                      </span>
                      ) : (null)}
                     ...
                     { this.props.health.detailed_final_step_points.weight > 0 ? (
                      <span>
                       ...
                       <p style={{fontSize: '15px', fontStyle: 'italic', marginTop: '-15px', paddingLeft: '20px'}} > - No entry on {this.props.health.detailed_final_step_points.weight} days 
                          {this.props.health.first_step_points <= 1 ? (<span style={{color: 'green',fontSize: '12px'}}> (1x{this.props.health.detailed_final_step_points.weight} points)</span>) : null}
                          {this.props.health.first_step_points === 2 || this.props.health.first_step_points === 3 ? (<span style={{color: '#ffc459', fontSize: '12px'}}> (2x{this.props.health.detailed_final_step_points.weight} points)</span>) : null}
                          {this.props.health.first_step_points > 3 ? (<span style={{color: 'red',fontSize: '12px'}}> (3x{this.props.health.detailed_final_step_points.weight} points)</span>) : null}
                       .</p>
                      </span>
                      ) : (null)}
